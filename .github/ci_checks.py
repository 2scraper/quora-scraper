...
#
# Deliberately WITHOUT this site's asset hosts. Quora serves its images from
# `qph.cf2.quoracdn.net/main-qimg-<32 hex>` — which DOES reach 32 characters
# and would trip this check — so `make_fixtures.py` replaces every 24+
# character hex run in a committed fixture with REDACTED-HEX before it is
# written, and the fixtures carry none. An allowlist entry for the asset host
